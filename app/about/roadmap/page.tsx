  ...
  return [
    ...
    },
    {
      ...
      items: [
        ...
        "Add ontology-grounded entity resolution: resolve every LLM-extracted compound, condition, and gene against canonical biomedical registries (ChEMBL or DrugBank, MONDO, HGNC), canonicalize the identifier, and enrich with structured metadata before write",
