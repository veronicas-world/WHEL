        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 56 }}>
          ...
          <section id="purpose" style={{ scrollMarginTop: 80 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <p style={BODY}>
                ...
                . The dimension scoring is generated by Claude Opus 4.8 against
                source content captured at indexing time, then combined with the
                deterministic female-applicability multiplier and tier in code,
                and stored alongside the signal. The question this page addresses is one step
          ...
          >
            ...
            >
              ...
              Opus 4.8 to extract a 2-4 sentence key finding focused on
