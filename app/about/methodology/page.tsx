      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
        <div style={{ display: "flex", flexDirection: "column", gap: 56 }}>
          ...
          >
            ...
            >
              Site-wide citation audit. Five citations from earlier
              methodology entries that were generated by the LLM
              scoring layer were flagged in external review as either
              misattributed or post-knowledge-cutoff fabrications. Each
              was verified against canonical external sources (NCBI
              E-utilities, Crossref, arXiv) and either updated to its
              real bibliographic record, replaced with a real
              substitute supporting the same claim, or dropped and the
              surrounding claim rewritten. Fixes were applied to every
              public surface where the flagged citations appeared.
              This audit is the manual version of Path C Phase 1, the
              citation-validation step recorded on the Roadmap that
              will run as code once shipped. See the full v3.7 entry
              on the{" "}
              <Link
            ...
            >
              ...
              >
                8 dated revisions &middot; v2 through v3.7
              </span>
              <Link
                href="/about/methodology/changelog"
                style={{
