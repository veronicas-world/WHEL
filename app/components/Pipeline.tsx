const STAGES = [
  ...
  { k: "Tier",      t: "Confidence tiering",                d: "Strong to exploratory — never flattened into one weight." },
  { k: "Candidate", t: "505(b)(2)-ready trail",             d: "Which drug, which condition, which regulatory path." },
];
